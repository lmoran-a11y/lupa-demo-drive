          ...
          <div className="mt-8 grid gap-5 sm:grid-cols-2 md:grid-cols-4">
            {VEHICLES.map((v) => (
              <button
                ...
                className={`group relative flex aspect-[4/4.2] flex-col rounded-2xl border bg-[#111111] p-5 text-left text-white shadow-[0_10px_30px_-15px_rgba(0,0,0,0.6)] transition hover:-translate-y-0.5 hover:shadow-[0_18px_40px_-18px_rgba(0,0,0,0.8)] ${
      ...
      <section className="mx-auto max-w-7xl px-6 pb-16">
        <div className="grid items-center gap-4 rounded-2xl border border-border bg-muted/60 px-6 py-3 md:grid-cols-[auto_1fr_auto]">
          ...
          <div className="hidden md:flex justify-center">
            <img src={carClasico} alt="Coche clásico" loading="lazy" width={1024} height={576} className="h-28 w-auto object-contain px-[35px]" />
          </div>
