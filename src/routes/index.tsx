          ...
          <div className="mt-8 grid gap-5 sm:grid-cols-2 md:grid-cols-4">
            {VEHICLES.map((v) => (
              <button
                ...
                className={`group relative flex aspect-[4/4.2] flex-col rounded-2xl border bg-[#1e1e1e] p-5 text-left text-white shadow-[0_10px_30px_-15px_rgba(0,0,0,0.6)] transition hover:-translate-y-0.5 hover:shadow-[0_18px_40px_-18px_rgba(0,0,0,0.8)] ${
